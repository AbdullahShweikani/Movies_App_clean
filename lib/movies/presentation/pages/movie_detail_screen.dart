...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MoviesDetailsBloc, MoviesDetailsState>(
      buildWhen: (previous, current) => previous.moviesDetailState!=current.moviesDetailState,
      builder: (context, state) {
        switch (state.moviesDetailState) {
          ...
          case RequestState.error:
            return Center(
              child: Text(state.moviesDetailMessage),
            );
        }
      },
    );
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MoviesDetailsBloc, MoviesDetailsState>(
      buildWhen: (previous, current) => previous.recommendationState!=current.recommendationState,
      builder: (context, state) {
